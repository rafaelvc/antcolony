...
# def hill_climbing_(op, escolha_viz, solucao, custo1, mat1, matprec):
...
def run_paco(mat1, mat2, matprec):
	...
	while it < maxit:
		...
		while ant < ants:
			...
			print "aaa"
			pareto_local_search ("best_first", mat1, mat2, matprec, solucao, custo1, custo2, pareto_local, pareto_custo1_local, pareto_custo2_local)
			print "passou"
			print pareto_local 
			print pareto_custo1_local
			print pareto_custo2_local
			...
			i=0
			for s in pareto_local:
				c1 = pareto_custo1_local[i]
				c2 = pareto_custo2_local[i]
			...
			for s in pareto_local:
				c1 = pareto_custo1_local[i]
				c2 = pareto_custo2_local[i]
				pareto_addnd(s, c1, c2, pareto, pareto_custo1, pareto_custo2)
				i += 1
